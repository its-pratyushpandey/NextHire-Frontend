...
const Applicants = () => {
    ...
    const fetchAllApplicants = async () => {
        try {
            setIsLoading(true);
            const res = await axios.get(`${APPLICATION_API_END_POINT}/${params.id}/applicants`, { withCredentials: true }); // APPLICATION_API_END_POINT already updated to backend link
