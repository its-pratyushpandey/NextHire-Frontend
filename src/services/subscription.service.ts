...
export const getSubscriptionUsage = async () => {
  try {
    const response = await fetch('https://nexthire-backend-ereo.onrender.com/api/v1/subscription/usage');
    return await response.json();
  } catch (error: any) {
...
export const getBillingHistory = async () => {
  try {
    const response = await fetch('https://nexthire-backend-ereo.onrender.com/api/v1/subscription/billing-history');
    return await response.json();
  } catch (error: any) {
